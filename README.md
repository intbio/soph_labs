...
- Данная практика обычно проходится после второго курса, но может быть пройдена и раньше (это приветствуется) или позже по согласованию в самостоятельном режиме.
